...
class BaseStationEnv(gym.Env):
    def __init__(self):
        ...
        # 时间间隔 LSTM Train
        self.LSTM_model_user1, self.scale1 = functions.LSTM_Train('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM1.csv', self.scaler1)
        self.LSTM_model_user2, self.scale2 = functions.LSTM_Train('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM1.csv', self.scaler2)
        self.LSTM_model_user3, self.scale3 = functions.LSTM_Train('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM1.csv', self.scaler3)
        self.LSTM_model_user4, self.scale4 = functions.LSTM_Train('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM1.csv', self.scaler4)
        self.LSTM_model_user5, self.scale5 = functions.LSTM_Train('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM1.csv', self.scaler5)

        self.LSTM_predict_user1 = pd.read_csv('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM2.csv',header=None).to_numpy()
        self.LSTM_predict_user2 = pd.read_csv('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM2.csv',header=None).to_numpy()
        self.LSTM_predict_user3 = pd.read_csv('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM2.csv',header=None).to_numpy()
        self.LSTM_predict_user4 = pd.read_csv('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM2.csv',header=None).to_numpy()
        self.LSTM_predict_user5 = pd.read_csv('/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM2.csv',header=None).to_numpy()
        #2.定义5个user的数据
        ...
        if Vars.time <= 71:
            ...
            if Vars.time < LSTM_user1_arrivalTime:  # 说明当前的时间还在预测范围内，则这次就可以不用预测，直到下一次数据到达时，再预测
                ...
                time_next_arrival_user1 = functions.LSTM_predict(
                    ...
                    '/Users/sunshuo/Desktop/LSTM/data/6_original_with_small_interval/user1/small_interval_LSTM2.csv',
                    self.scaler1,
