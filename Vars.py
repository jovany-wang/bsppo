...
'''
定义LSTM_user_arrivalTime
'''
global LSTM_user1_arrivalTime
LSTM_user1_arrivalTime = 0

global LSTM_user2_arrivalTime
LSTM_user2_arrivalTime = 0

global LSTM_user3_arrivalTime
LSTM_user3_arrivalTime = 0

global LSTM_user4_arrivalTime
LSTM_user4_arrivalTime = 0

global LSTM_user5_arrivalTime
LSTM_user5_arrivalTime = 0

'''
最后在main中画图
'''
global energy_sum_plt
energy_sum_plt = []

global delay_total_plt
delay_total_plt = []

global delay_BS0_plt
delay_BS0_plt = []

global delay_BS1_plt
delay_BS1_plt = []

global delay_BS2_plt
delay_BS2_plt = []
